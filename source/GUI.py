...
class GUI:
	...
	def __init__(self):
		...
		self.boardFrame = Frame(self.mainFrame,bg = "#DCDCDC") 
		...
		for i in range(0,3):
			...
			for j in range(0,3):
				...
				if not (i == 0 and j == 0):
					self.labels[i][j] = Button(self.boardFrame,text=str(i*3+j),font=('Times 26 bold'),height = 5 , width = 18,bg='#2F4F4F',fg='white')
